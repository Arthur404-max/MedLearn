...
async function loadUserData() {
    ...
    document.getElementById('subscriptionStatus').textContent = user.subscription?.plan || 'Нет активной подписки';
}

// Загрузка статистики тестирования
async function loadTestingStats() {
    ...
    try {
        ...
        if (response.ok) {
            ...
            document.getElementById('testsCompleted').textContent = stats.totalTests;
...
function editProfile() {
    // TODO: Реализовать модальное окно редактирования профиля
